 ...
 */
class Version20150326160101 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE `users` CHANGE `gender` `user_gender` varchar(255) COLLATE \'utf8_unicode_ci\' NULL AFTER `last_name`, COMMENT=\'\'');
        $this->addSql('ALTER TABLE `users` CHANGE `first_name` `firstname` varchar(255) COLLATE \'utf8_unicode_ci\' NULL AFTER `credentials_expire_at`, CHANGE `last_name` `lastname` varchar(255) COLLATE \'utf8_unicode_ci\' NULL AFTER `firstname`, COMMENT=\'\'');
        ...
        $this->addSql('ALTER TABLE users ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL, ADD website VARCHAR(64) DEFAULT NULL, ADD biography VARCHAR(1000) DEFAULT NULL, ADD gender VARCHAR(1) DEFAULT NULL, ADD locale VARCHAR(8) DEFAULT NULL, ADD timezone VARCHAR(64) DEFAULT NULL, ADD phone VARCHAR(64) DEFAULT NULL, ADD facebook_uid VARCHAR(255) DEFAULT NULL, ADD facebook_name VARCHAR(255) DEFAULT NULL, ADD facebook_data LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', ADD twitter_uid VARCHAR(255) DEFAULT NULL, ADD twitter_name VARCHAR(255) DEFAULT NULL, ADD twitter_data LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', ADD gplus_uid VARCHAR(255) DEFAULT NULL, ADD gplus_name VARCHAR(255) DEFAULT NULL, ADD gplus_data LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', ADD token VARCHAR(255) DEFAULT NULL, ADD two_step_code VARCHAR(255) DEFAULT NULL, CHANGE firstname firstname VARCHAR(64) DEFAULT NULL, CHANGE lastname lastname VARCHAR(64) DEFAULT NULL, CHANGE date_of_birth date_of_birth DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE users DROP created_at, DROP updated_at, DROP website, DROP biography, DROP gender, DROP locale, DROP timezone, DROP phone, DROP facebook_uid, DROP facebook_name, DROP facebook_data, DROP twitter_uid, DROP twitter_name, DROP twitter_data, DROP gplus_uid, DROP gplus_name, DROP gplus_data, DROP token, DROP two_step_code, CHANGE date_of_birth date_of_birth DATE DEFAULT NULL, CHANGE firstname firstname VARCHAR(255) DEFAULT NULL, CHANGE lastname lastname VARCHAR(255) DEFAULT NULL');

        $this->addSql('ALTER TABLE `users` CHANGE `firstname` `first_name` varchar(255) COLLATE \'utf8_unicode_ci\' NULL AFTER `credentials_expire_at`, CHANGE `lastname` `last_name` varchar(255) COLLATE \'utf8_unicode_ci\' NULL AFTER `first_name`, COMMENT=\'\'');
        $this->addSql('ALTER TABLE `users` CHANGE `user_gender` `gender` varchar(255) COLLATE \'utf8_unicode_ci\' NULL AFTER `last_name`, COMMENT=\'\'');
    }
}
